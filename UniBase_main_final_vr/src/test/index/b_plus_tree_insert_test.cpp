...
public:
    ...
    void SetUp() override
    {
        ...
        //************ bug-b_plus_tree_insert_test: /mnt/UniBase/UniBase-main/src/test/index/b_plus_tree_insert_test.cpp:74: virtual void BPlusTreeTests::SetUp(): Assertion `ix_manager_->exists(TEST_FILE_NAME, TEST_COL)' failed.
        // crtl+左键可以找到变量源文件对应位置
